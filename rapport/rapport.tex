...
La \fig{fig:spectre-za} indique qu'il serait raisonnable de faire jusqu'à 5 groupes, les valeurs propres autour de 1,8 étant assez
rapprochées.
...
de sens : comme le montre la \fig{fig:spectre-do}, $\lambda_3$ et $\lambda_4$ sont très resserrées, on a pas de <<~vraie~>> raison
de choisir $v_3$ plutôt que $v_4$ pour la séparation, qui perdrait alors son sens.

\begin{figure}[htb]
	\begin{center}
		\includegraphics[width=\textwidth]{new_plots/spectre-za}
	\end{center}
	\caption{Repartition des premières valeurs propres de la Laplacienne pour Zachary}
	\label{fig:spectre-za}
\end{figure}

\begin{figure}[htb]
	\begin{center}
		\includegraphics[width=\textwidth]{new_plots/spectre-do}
	\end{center}
	\caption{Repartition des premières valeurs propres de la Laplacienne pour les dauphins}
	\label{fig:spectre-do}
\end{figure}
\section{Conclusion}
bonsoir
